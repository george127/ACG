            ...
            <div className="Content">
              ...
              <section id="section1"
                ...
                <div className="button-container">
                  ...
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-Fund-Details" className="btn">
                      Learn More
              ...
              <section id="section2"
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-A-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              className={`section ${activeSection === "section3" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-Se-Com-Fun-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section4"
               className={`section ${activeSection === "section4" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-Data-En-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section5" 
               className={`section ${activeSection === "section5" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-Data-S-S-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section6" 
               className={`section ${activeSection === "section6" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-A-R-D-Micro-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section7"  className={`section ${activeSection === "section7" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-D-S-Micro-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section8" 
               className={`section ${activeSection === "section8" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-I-E-S-A-S-Power-BI-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              className={`section ${activeSection === "section9" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Azure-Des-Imple-Micro-A-N-S-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              className={`section ${activeSection === "section10" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/AzureMicro-Sec-Tech-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section11" 
               className={`section ${activeSection === "section11" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Micro-I-A-Ad-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section12" 
               className={`section ${activeSection === "section12" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Micro-Sec-Op-A-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section13" 
               className={`section ${activeSection === "section13" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Ad-W-Se-Hy-Co-Inf-Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section14" 
               className={`section ${activeSection === "section14" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/C-Op-Micro-V-Desk.Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section15" 
               className={`section ${activeSection === "section15" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Des-Micro-A-I-S.Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              className={`section ${activeSection === "section16" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Micro-Cyber-Arch.Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
              ...
              <section id="section17" 
               className={`section ${activeSection === "section17" ? "section-active" : ""}`}
                ...
                <div className="button-container">
                  <p className="amount">Ghc 5,920</p>
                  <div className="btn-container">
                    <NavLink to="/Azure/Des-I-Micro-Dev-S.Details" className="btn">
                      Learn More
                      <span className="material-symbols-outlined">east</span>
                    </NavLink>
                  </div>
