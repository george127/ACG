...
import DashboardOverview from "../AdminDashboard/DashboardOverview.jsx";
import StudentManagement from "../AdminDashboard/StudentManagement.jsx";
import CourseManagement from "../AdminDashboard/CourseManagement.jsx";
import PaymentManagement from "../AdminDashboard/PaymentManagement.jsx";
import ReportsAnalytics from "../AdminDashboard/ReportsAnalytics.jsx";
import SystemSettings from "../AdminDashboard/SystemSettings.jsx";
import CourseContentManagement from "../AdminDashboard/CourseContentManagement.jsx";
    ...
    <div className="d-flex admin-dashboard">
      ...
      <div className="admin-sidebar">
        ...
        <ul className="p-3 nav flex-column">
          ...
          <li className="mb-3 nav-item">
            <button className={`nav-link ${activeSection === "content" ? "active" : ""}`} onClick={() => setActiveSection("content")}>
          ...
          <li className="mb-3 nav-item">
            <button className={`nav-link ${activeSection === "payments" ? "active" : ""}`} onClick={() => setActiveSection("payments")}>
          ...
          <li className="mb-3 nav-item">
            <button className={`nav-link ${activeSection === "reports" ? "active" : ""}`} onClick={() => setActiveSection("reports")}>
