...
export const submitPersonalDetails = createAsyncThunk(
  ...
  async (personalDetails, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://appcodeglobal-backend.onrender.com/api/students/personalDetails', { personalDetails });
...
export const submitprogramApplyingFor = createAsyncThunk(
  ...
  async (programApplyingFor, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://appcodeglobal-backend.onrender.com/api/students/programApplyingFor', { programApplyingFor });
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
...
export const submitEducationalBackground = createAsyncThunk(
  ...
  async (educationalBackground, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://appcodeglobal-backend.onrender.com/api/students/educationalBackground', { educationalBackground });
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
...
export const submitGuardianDetails = createAsyncThunk(
  ...
  async (guardianDetails, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://appcodeglobal-backend.onrender.com/api/students/guardianDetails', { guardianDetails });
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
